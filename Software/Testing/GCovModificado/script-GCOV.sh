...
do
	...
	g++ -ftest-coverage -fprofile-arcs -fprofile-dir=./Corrida-$nombre ../../HuffmanModificado/*.cpp -fpermissive -o HuffmanCompressor
	cp ../../../ArchivosDePrueba/* ./
	...
	gcov -o ./Corrida-$nombre ../../HuffmanModificado/* >> RESULTADOS-$nombre.txt
	sleep 2
